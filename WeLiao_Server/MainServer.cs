...
{
    public partial class MainServer : SkinForm
    {
        /// <summary>
        /// 保存连接的所有用户
        /// </summary>
        ...
        private void ReceiveData(object userState)
        {
            ...
            while (IsExit == false)
            {
                ...
                try
                {
                    ...
                    receiveString = user._BinaryReader.ReadString();
                }
                catch (Exception)
                {
                    if (IsExit == false)
                ...
                AddChatsToListBox(string.Format("来自[{0}]：{1}", user._TcpClient.Client.RemoteEndPoint, receiveString));
                ...
                switch (splitString[0])
                {
                    ...
                    case "Talk"://聊天消息
                        ...
                        AddChatsToListBox(string.Format("{0}对{1}说：{2}", user.UserName, splitString[1], talkString));
